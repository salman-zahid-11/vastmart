  ...
  return (
    <div className="auth-page">
      <div className="auth-panel">
        <p className="auth-panel__eyebrow">Join VastMart</p>
        <h1 className="auth-panel__title">Everything you need, in one vast marketplace.</h1>
        <p className="auth-panel__subtitle">
          Create an account to track orders, save favorites, and get personalized picks
          from thousands of sellers across Bangladesh.
        </p>
